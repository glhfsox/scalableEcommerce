      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">eShop</h3>
            <p className="text-gray-400">
              We provide high-quality products at affordable prices. Shop with confidence!
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/sales" className="text-gray-400 hover:text-white">
                  Sales
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Subscribe to our newsletter to get updates about new products and offers.
            </p>
            <form className="flex">
              <input
                type="email"
